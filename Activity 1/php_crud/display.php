...
<div class="container">
    ...
    <?php
    // We select all necessary fields, using the new 'role_id' column name.
    $sql = "SELECT id, role_id, name, email, age, city_address, birthdate, role, created_at FROM users ORDER BY created_at DESC"; 
